...
(function() {
  ...
  PluginManager.add('customerplaceholder', function (editor) {
    ...
    var Label = function () {
      ...
      var placeholder_attrs = editor.settings.placeholder_attrs || { style: { position: 'absolute', top: '5px', left: 0, color: '#999', padding: '1%', width: '98%', overflow: 'hidden', 'white-space': 'pre-wrap' } }
